 ...
 * |--------+------+------+------+------+------| SYMB |           |  CAG |------+------+------+------+------+--------|
 * | Ctrl   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / MD|Ent/Ctrl|
 * |--------+------+------+------+------+------|   `  |           | LEAD |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |   ~  |           |      |   N  |   M  |   ,  |   .  |  UP  | / Shift|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |C_S_T |SYMB/`| AltG | Alt  |  Cmd |                                       |   [  |   ]  | LEFT | DOWN | RIGHT|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |  /?  |  '"  |       | Del  | AltGr|
 *                                 ,------|------|------|       |------+------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        C_S_T(KC_NO),  LT(SYMB,KC_GRV), KC_RALT, KC_LALT, KC_LGUI,
                                                      KC_SLSH,KC_QUOT,
                                                              KC_HOME,
        ...
        LCAG_T(KC_BSLS), KC_Y, KC_U,    KC_I,    KC_O,             KC_P,             KC_QUOT,
                         KC_H, KC_J,    KC_K,    KC_L,             LT(MDIA,KC_SCLN), CTL_T(KC_ENT),
...
[MDIA] = LAYOUT_ergodox(
        ...
        _______, _______, _______, _______, _______,  KC_PSCR, KC_APP,
